...
to compile use:  
```
gcc -Wall -pedantic -Werror -Wextra -std=gnu89 _putchar.c "mainfile" "myfile"
```
...
Write a program that <mark>prints ```_putchar```</mark>,  
...
Write a function that <mark>prints the alphabet</mark>, in lowercase, followed by a new line.
...
Write a function that <mark>prints 10 times the alphabet in lowercase</mark> followed by a new line.
...
Write a function that <mark>checks for lowercase character</mark>.
...
Write a function that <mark>checks for alphabetic character</mark>.
...
Write a function that <mark>prints the sign of a number</mark>.
...
Write a function that <mark>computes the absolute value of an integer</mark>.
...
Write a function that <mark>prints the last digit of a number</mark>.
...
Write a function that <mark>prints every minute of the day</mark> of Jack Bauer, starting from 00:00 to 23:59.
...
Write a function that <mark>prints the 9 times table</mark>, starting with 0.
...
Write a function that <mark>adds two integers</mark> and returns the result.
...
Write a function that <mark>prints all natural numbers from n to 98</mark>, followed by a new line.
